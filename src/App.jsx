...
const INITIAL_CONTENT = {
  ...
  contrato: "<h2 style=\"text-align:center;text-transform:uppercase;font-size:14pt\">CONTRATO DE ALQUILER DE HOSPEDAJE TURÍSTICO</h2><p>El presente contrato de alquiler turístico se regirá por las siguientes condiciones para las partes:</p><p><strong>Lugar del hospedaje turístico:</strong> Medellín, Colombia</p><p><strong>Dirección exacta del hospedaje:</strong> Edificio San Remo, apartamento #602, calle 45E #72-57, Laureles-Estadio.</p><p><strong>Persona que brindará el servicio de hospedaje:</strong> Yanina Mora Alvarado, cédula 1-1532-0201, con domicilio en San José, Costa Rica.</p><p><strong>Persona que recibirá el servicio de hospedaje:</strong> <strong>[nombre]</strong>, cédula <strong>[cedula]</strong>, con domicilio en [domicilio].</p><p><strong>Fechas del servicio de hospedaje:</strong> del <strong>[checkin]</strong> al <strong>[checkout]</strong> y que corresponde a <strong>[noches]</strong> noches de hospedaje.</p><p><strong>Monto total a pagar por el servicio de hospedaje:</strong> <strong>[moneda][monto]</strong>, a razón de <strong>[moneda][monto_noche]</strong> por noche.</p><p><strong>Forma de pago:</strong> la/el señor/a <strong>[nombre_corto]</strong> pagó el 100% del monto total correspondiente a <strong>[moneda][monto]</strong>.</p><p><strong>Cantidad de personas que utilizarán el hospedaje:</strong> el hospedaje será brindado para un total de <strong>[personas]</strong> personas. En caso de que se requiera adicionar más huéspedes, la persona que contrata el servicio deberá coordinarlo previamente con la Sra. Mora. En caso de que se requiera disminuir la cantidad de personas, el monto total no será modificado.</p><p><strong>Condiciones del servicio de hospedaje:</strong> la Sra. Mora se compromete a brindar el servicio en buenas condiciones de aseo y con el menaje necesario. Entre los servicios que se proporcionarán están: muebles de sala, televisores, muebles de comedor y cocina con su respectivo equipamiento, camas en sus dos habitaciones con su respectivo baño, servicio de internet, entre otras facilidades. Todo en excelentes condiciones.</p><p>Por su parte, la persona que contrata el servicio se compromete a entregar el apartamento y su equipamiento en las mismas condiciones en que fueron recibidos. Cualquier daño o pérdida causada por los huéspedes deberá ser informada inmediatamente a los propietarios y pagada en un máximo de dos días hábiles.</p><p><strong>Hora de ingreso y salida final del hospedaje (check in y check out):</strong> la hora de ingreso será el <strong>[checkin]</strong> a las <strong>[hora_checkin]</strong> y el check out se hará el <strong>[checkout]</strong> a las <strong>[hora_checkout]</strong>. Estas horas podrían ser modificadas, previo acuerdo de las partes.</p><p><strong>Otras condiciones acordadas:</strong></p><ul><li>Las personas se comprometen a no realizar ruidos excesivos que alteren la tranquilidad de los demás residentes del condominio.</li><li>No se permite el ingreso de visitantes o huéspedes no registrados.</li><li>Queda prohibido fumar o utilizar sustancias ilegales tanto en el apartamento como en el edificio.</li><li>No se permite realizar fiestas, reuniones o eventos en el apartamento.</li><li>Los huéspedes deberán mantener el inmueble en buenas condiciones de aseo durante todo el hospedaje.</li><li>No se permite sacar de la propiedad o dañar cualquier mueble, utensilio, electrodoméstico o artículo facilitado por la Sra. Mora para la estadía.</li><li>No se permiten mascotas de ningún tipo durante la estancia.</li><li>La señora Mora no será responsable por las lesiones, daños o pérdidas que pudiese sufrir la/s persona/s que contrata/n el servicio, sus familiares o terceros dentro del inmueble.</li></ul><p>Leído el presente documento por las partes interesadas, firmamos en San José, a los <strong>[dia]</strong> días del mes de <strong>[mes]</strong> de <strong>[anio]</strong>.</p><br/><br/><table style=\"width:100%;margin-top:40px\"><tr><td style=\"width:50%;text-align:center;border-top:1px solid #000;padding-top:8px\"><strong>Yanina Mora Alvarado</strong></td><td style=\"width:50%;text-align:center;border-top:1px solid #000;padding-top:8px\"><strong>[nombre]</strong></td></tr></table>",
  mensajes: {
  ...
  const sections = [
    ...
    },
    {
      ...
      render: () => {
        ...
        return (
          <div>
            <div style={{ background: "#D1FAE5", border: "1px solid #6EE7B7", borderRadius: 14, padding: 14, marginBottom: 10 }}>
              <p style={{ margin: "0 0 4px", fontSize: 11, fontWeight: 700, color: "#2D6A4F", textTransform: "uppercase", letterSpacing: "0.12em" }}>{tr.red}</p>
              <p style={{ margin: 0, fontWeight: 800, fontSize: 24, letterSpacing: "0.15em", color: "#111827" }}>{c.wifi.nombre}</p>
            </div>
            <div style={{ background: "#D1FAE5", border: "1px solid #6EE7B7", borderRadius: 14, padding: 14, marginBottom: 10 }}>
      ...
      <div style={{maxWidth:560,margin:"0 auto",paddingBottom:40}}>
        ...
        <div style={{background:"#fff",padding:"0 16px 16px"}}>
          <img
            ...
            alt={t.rules_title}
            style={{width:"100%",display:"block",maxHeight:200,objectFit:"contain",borderRadius:12}}
